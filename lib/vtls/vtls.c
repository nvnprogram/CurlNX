                        ...
                        struct ssl_primary_config* needle)
{
  if((data->version == needle->version) &&
     ...
     (data->skipssldefaultverify == needle->skipssldefaultverify) &&
     (data->verifydate == needle->verifydate) &&
                              ...
                              struct ssl_primary_config *dest)
{
  ...
  dest->skipssldefaultverify = source->skipssldefaultverify;
  dest->verifydate = source->verifydate;

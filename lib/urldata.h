...
struct ssl_primary_config {
  ...
  bit skipssldefaultverify:1; /* Nintendo: skip nn::ssl default verification
                                 (CURLOPT_SSL_SKIP_DEFAULT_VERIFY) */
  bit verifydate:1;      /* Nintendo: enable nn::ssl certificate date check */
};
...
struct ssl_config_data {
  ...
  /* Nintendo nn::ssl additions */
  void *psslctx;          /* pre-created nn::ssl::Context* (optional) */
  curl_ssl_conn_callback_before fsslconnbefore; /* before DoHandshake() */
  curl_ssl_conn_callback_after  fsslconnafter;  /* after DoHandshake() */
  void *psslcondata;      /* parameter for the conn before/after callbacks */
  long dohandshakeresult; /* last nn::ssl handshake nn::Result value */
